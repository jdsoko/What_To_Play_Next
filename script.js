...
function readDescription(input){
 ...
 function getTrailer(input1, input2){
    ...
    fetch(`https://www.googleapis.com/youtube/v3/search?part=snippet&q=${input2.split(' ').join('%20')}%20original%20game%20trailer&topicId=%2Fm%2F0bzvm2&type=video&key=AIzaSyBE0HctoldZZwvobhkivNy0f4hVM3Oh7yg`)
     .then(response => response.json())
